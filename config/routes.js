...
module.exports = function(app, passport) {
	...
	// Dummy api routes. Replace these with the real stuff. The '/api'
	// middleware will handle authorization. Check line 18 in this file.
	app.route('/api/patients/:id').get(function(req, res) {
		var data = {
			patient : 'name' + req.params.id
		}
		res.json(data);
	});

	app.route('/api/patients').get(function(req, res) {
		var data = {
